...
def check_database():
    ...
    with app.app_context():
        ...
        version_meta = (
            ...
            .filter(ScheduleVersionMeta.version == 2)
            .first()
        )
        if version_meta:
            ...
            print(
                f"  Date range: {version_meta.date_range_start} to {version_meta.date_range_end}"
            )
        ...
        print(
            "Check src/backend/services/scheduler/generator.py for the _save_to_database method"
        )
