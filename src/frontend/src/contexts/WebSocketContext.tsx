  ...
  useEffect(() => {
    ...
    socket.on("schedule_updated", (data) => {
      window.dispatchEvent(
        new CustomEvent("websocket-schedule_updated", { detail: data }),
      );
    });
    ...
    socket.on("availability_updated", (data) => {
      window.dispatchEvent(
        new CustomEvent("websocket-availability_updated", { detail: data }),
      );
    });
    ...
    socket.on("settings_updated", (data) => {
      window.dispatchEvent(
        new CustomEvent("websocket-settings_updated", { detail: data }),
      );
    });
  ...
  return (
    <WebSocketContext.Provider
      value={{
        ...
        reconnect: () =>
          window.dispatchEvent(
            new CustomEvent("websocket-reconnect-requested"),
          ),
      }}
    >
      {children}
