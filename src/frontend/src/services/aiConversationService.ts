...
class AIConversationService {
     ...
     */
    async getRecommendations(optimizationGoals?: string[]): Promise<ConversationResponse> {
        if (!this.conversationId) {
            throw new Error('No active conversation');
        }
     ...
     */
    async generateSchedule(applyRecommendations: boolean = true, constraints?: any): Promise<ConversationResponse> {
        if (!this.conversationId) {
            throw new Error('No active conversation');
        }
     ...
     */
    async adjustSchedule(modifications: ConversationModification[], regenerateAffected: boolean = true): Promise<ConversationResponse> {
        if (!this.conversationId) {
            throw new Error('No active conversation');
        }
