...
export const EmployeeSettingsEditor: React.FC<EmployeeSettingsEditorProps> = ({
  groups,
  onChange,
  type,
}) => {
  ...
  const handleSaveGroup = () => {
    ...
    if (
      existingIndex >= 0 &&
      editingGroup.id === localGroups[existingIndex].id
    ) {
        ...
        <div className="grid grid-cols-2 gap-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                setEditingGroup({ ...editingGroup, id: e.target.value })
              }
            />
          </div>
