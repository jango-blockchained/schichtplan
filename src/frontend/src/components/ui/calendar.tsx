    ...
    return (
        <DayPicker
            ...
            formatters={{
                ...
                formatDay: (date, options) => format(date, 'd', { locale: options?.locale }),
                formatWeekdayName: (date) => format(date, 'EEEEE', { locale: de })
            }}
            classNames={{
                ...
                head_row: "flex w-full justify-around px-2",
                head_cell:
                    "text-muted-foreground w-9 font-normal text-[0.8rem] text-center",
                row: "flex w-full justify-around px-2 mt-2",
