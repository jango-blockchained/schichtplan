...
import { CalendarPlus, Edit, Trash, Calendar as CalendarIcon, Import } from 'lucide-react';
...
export const SpecialDaysManagement: React.FC<SpecialDaysManagementProps> = ({
  ...
  const fetchHolidays = async () => {
    ...
    try {
      ...
      const mockHolidays = [
        { date: `${selectedYear}-01-01`, name: 'New Year\'s Day', type: 'National' },
        { date: `${selectedYear}-05-01`, name: 'Labor Day', type: 'National' },
        { date: `${selectedYear}-10-03`, name: 'German Unity Day', type: 'National' },
        { date: `${selectedYear}-12-25`, name: 'Christmas Day', type: 'National' },
        { date: `${selectedYear}-12-26`, name: 'Second Christmas Day', type: 'National' }
      ];
              ...
              <TableBody>
                {getSortedSpecialDays().map((day) => (
                  <TableRow key={day.date}>
                    ...
                    <TableCell>{day.is_closed ? 'Closed' : 'Custom Hours'}</TableCell>
                    <TableCell>
                      {day.is_closed 
                        ? '-' 
                    ...
                    <TableCell>
                      <div className="flex space-x-2">
                        <Button variant="ghost" size="sm" onClick={() => handleEditSpecialDay(day)}>
                          <Edit className="h-4 w-4" />
                        </Button>
                        <Button variant="ghost" size="sm" onClick={() => handleDeleteSpecialDay(day.date)}>
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="special-day-closed">Store is closed on this day</Label>
            </div>
