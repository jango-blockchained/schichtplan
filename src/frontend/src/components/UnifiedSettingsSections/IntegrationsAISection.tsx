...
interface IntegrationsAISectionProps {
  ...
  onSettingChange: (key: keyof NonNullable<Settings['ai_scheduling']>, value: any) => void;
    ...
    <Card>
      ...
      <CardContent className="space-y-6">
        <div className="flex items-center justify-between space-x-2 p-4 border rounded-md">
          <Label htmlFor="ai-schedule-generation-enabled" className="flex flex-col space-y-1 cursor-pointer">
