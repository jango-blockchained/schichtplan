...
function MEPHeaderSectionComponent({
  config,
  onChange,
  className = "",
}: MEPHeaderSectionProps) {
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleStoreFieldChange("label", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleStoreFieldChange("value", e.target.value)
                  }
            ...
            <div className="space-y-3">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    handleStorageNoteChange("text", e.target.value)
                  }
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    handleStorageNoteChange("position", value)
                  }
                >
