...
export const AIScheduleSuggestionsPanel: React.FC<
  AIScheduleSuggestionsPanelProps
> = ({
  className,
  dateRange,
  scheduleId,
  ...
  const fetchSuggestions = async () => {
    ...
    try {
      ...
      const result =
        await enhancedAIService.getProactiveSuggestions(enrichedContext);
      ...
      <CardContent>
        ...
        <div className="flex items-center justify-between text-xs text-muted-foreground">
          <div className="flex items-center gap-1">
            ...
            <span>{highPrioritySuggestions} high priority</span>
          </div>
          <div className="flex items-center gap-1">
