...
import { aiService, type WorkflowExecution, type WorkflowStep, type WorkflowTemplate } from "@/services/aiService";
import {
    Activity,
    AlertTriangle,
    CheckCircle2,
...
export const WorkflowExecutor: React.FC<WorkflowExecutorProps> = ({ className }) => {
    ...
    useEffect(() => {
        ...
        const handleWorkflowUpdate = (data: {
            ...
            setState(prev => ({
                ...
                currentExecution: prev.currentExecution?.id === data.execution_id
                    ? { ...prev.currentExecution, status: data.status as any, progress: data.progress }
    ...
    const executeWorkflow = async (templateId: string, inputs: Record<string, unknown>) => {
                            ...
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-1">
                                        ...
                                        <span className="text-sm capitalize">{state.currentExecution.status}</span>
                                    </div>
                                </div>
                                ...
                                <div className="flex gap-1">
                                    ...
                                    {['running', 'paused'].includes(state.currentExecution.status) && (
                                        <Button
                                            size="sm"
                                            variant="outline"
