            ...
            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm">{systemStatus.agents.active}/{systemStatus.agents.total} Agents</span>
                    </div>
                    <div className="flex items-center gap-2">
                        <MessageSquare className="h-4 w-4 text-purple-500" />
                        <span className="text-sm">{systemStatus.conversations.active} Active</span>
                    </div>
                </div>
            </div>
                            ...
                            <CardContent>
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-sm text-muted-foreground">
                                        Detaillierte KI-Leistungsanalysen und Einblicke werden hier angezeigt
                                    </p>
                                </div>
                            </CardContent>
                        </Card>
