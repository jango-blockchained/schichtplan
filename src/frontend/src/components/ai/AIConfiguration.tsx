...
export const AIConfiguration: React.FC<AIConfigurationProps> = ({ className }) => {
    ...
    const testProvider = async (provider: 'openai' | 'anthropic' | 'gemini') => {
        ...
        try {
            ...
            if (result.success) {
                ...
                toast.success(`${provider.toUpperCase()} verbunden (${result.response_time}ms)`);
            } else {
            ...
            <Tabs defaultValue="providers" className="space-y-4">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm">{getStatusText(providerStatus.gemini)}</span>
                                        <Button
                                            size="sm"
                                            variant="outline"
                                ...
                                <Input
                                    ...
                                    value={showApiKeys ? settings.providers.gemini_api_key : maskApiKey(settings.providers.gemini_api_key || '')}
                                    onChange={(e) => updateSetting(['providers', 'gemini_api_key'], e.target.value)}
                                />
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm">{getStatusText(providerStatus.openai)}</span>
                                        <Button
                                            size="sm"
                                            variant="outline"
                                ...
                                <Input
                                    ...
                                    value={showApiKeys ? settings.providers.openai_api_key : maskApiKey(settings.providers.openai_api_key || '')}
                                    onChange={(e) => updateSetting(['providers', 'openai_api_key'], e.target.value)}
                                />
                                <Badge variant="outline" className="text-xs">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className="text-sm">{getStatusText(providerStatus.anthropic)}</span>
                                        <Button
                                            size="sm"
                                            variant="outline"
                                ...
                                <Input
                                    ...
                                    value={showApiKeys ? settings.providers.anthropic_api_key : maskApiKey(settings.providers.anthropic_api_key || '')}
                                    onChange={(e) => updateSetting(['providers', 'anthropic_api_key'], e.target.value)}
                                />
                                <Badge variant="outline" className="text-xs">
                        ...
                        <CardContent className="space-y-4">
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => updateSetting(['agents', 'schedule_agent_enabled'], checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => updateSetting(['agents', 'analytics_agent_enabled'], checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => updateSetting(['agents', 'notification_agent_enabled'], checked)}
                                />
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="space-y-6">
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => updateSetting(['workflow', 'auto_approval_enabled'], checked)}
                                />
                            </div>

                            <div className="space-y-2">
                                <Label>Max Concurrent Workflows: {settings.workflow.max_concurrent_workflows}</Label>
                                <Slider
                                    value={[settings.workflow.max_concurrent_workflows]}
                                    onValueChange={([value]) => updateSetting(['workflow', 'max_concurrent_workflows'], value)}
                                    max={10}
                                    min={1}
                                    step={1}
                                    className="w-full"
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <Switch
                                        ...
                                        onCheckedChange={(checked) => updateSetting(['voice', 'voice_commands'], checked)}
                                    />
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="space-y-4">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Switch
                                        ...
                                        onCheckedChange={(checked) => updateSetting(['files', 'upload_enabled'], checked)}
                                    />
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    <Slider
                                        ...
                                        onValueChange={([value]) => updateSetting(['files', 'max_file_size'], value)}
                                        max={100}
                                        min={1}
                                        step={1}
                                        className="w-full"
                ...
                <TabsContent value="advanced" className="space-y-4">
                    <Card>
                        ...
                        <CardContent className="space-y-6">
                            <div className="space-y-2">
                                <Label>Max Conversation Length: {settings.chat.max_conversation_length}</Label>
                                <Slider
                                    value={[settings.chat.max_conversation_length]}
                                    onValueChange={([value]) => updateSetting(['chat', 'max_conversation_length'], value)}
                                    max={1000}
                                    min={10}
                                    step={10}
                                    className="w-full"
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => updateSetting(['realtime', 'typing_indicators'], checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => updateSetting(['realtime', 'live_updates'], checked)}
                                />
                            </div>
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <Switch
                                    ...
                                    onCheckedChange={(checked) => updateSetting(['realtime', 'websocket_enabled'], checked)}
                                />
                            </div>
                        </CardContent>
                    </Card>
