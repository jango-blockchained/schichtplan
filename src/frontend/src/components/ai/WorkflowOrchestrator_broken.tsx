...
import { aiService, type WorkflowTemplate, type WorkflowExecution } from "@/services/aiService";
import {
    AlertCircle,
    BarChart3,
    CheckCircle,
...
interface LocalWorkflowTemplate extends WorkflowTemplate {
...
interface ActiveWorkflow extends WorkflowExecution {
  current_step?: string;
