      ...
      <Card className="shadow-sm">
        ...
        <CardContent>
          <div className="grid grid-cols-3 gap-4">
            ...
            <div className="flex flex-col items-center">
              <span className="text-2xl font-bold">{stats.scheduledEmployeesCount}/{stats.totalEmployeesCount}</span>
            ...
            <div className="space-y-3">
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span>{stats.earlyShifts} ({stats.earlyPercentage.toFixed(0)}%)</span>
                </div>
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span>{stats.midShifts} ({stats.midPercentage.toFixed(0)}%)</span>
                </div>
              ...
              <div>
                <div className="flex justify-between text-xs mb-1">
                  ...
                  <span>{stats.lateShifts} ({stats.latePercentage.toFixed(0)}%)</span>
                </div>
          ...
          <CardContent>
            ...
            <div className="mt-3">
              <div className="flex justify-between text-xs mb-1">
                ...
                <span>{stats.hoursUtilization.toFixed(0)}% of contracted hours</span>
              </div>
              <Progress value={stats.hoursUtilization} className="h-2" />
            </div>
            <div className="mt-3 text-xs text-muted-foreground">
              <p>Total Hours: {stats.totalHours.toFixed(1)} / {stats.contractedHoursForPeriod.toFixed(1)} contracted</p>
            </div>
          </CardContent>
        </Card>
      </div>
...
// Calculate simple numeric statistics
function calculateNumericStats(schedules: Schedule[], employees: Employee[], dateRange: { from: Date; to: Date }) {
  ...
  const totalContractedHours = employees.reduce((sum, emp) => sum + (emp.contracted_hours || 0), 0);
