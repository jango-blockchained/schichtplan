...
export const MonthlyView = ({
    ...
    const daysToShow = eachDayOfInterval({ 
        ...
        end: addDays(lastDayOfMonth, 42 - (adjustedStartDay + lastDayOfMonth.getDate()))
    });
                    ...
                    {daysToShow.map((day) => {
                        ...
                        daySchedules.forEach(schedule => {
                            if (schedule.shift_type_id) {
                                shiftCounts[schedule.shift_type_id] = (shiftCounts[schedule.shift_type_id] || 0) + 1;
                            }
                        });
                            ...
                            >
                                ...
                                <div className="mt-2 space-y-1">
                                    {Object.entries(shiftCounts).map(([shiftType, count]) => (
                                        <div key={shiftType} className="flex justify-between items-center text-xs">
