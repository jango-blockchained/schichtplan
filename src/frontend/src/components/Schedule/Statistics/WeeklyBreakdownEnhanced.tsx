              ...
              >
                ...
                <Tooltip
                  formatter={(value: number, name: string) => {
                    switch (name) {
                      case "hours":
                        return [`${value.toFixed(1)}h`, "Stunden"];
                      case "shifts":
                        return [`${value} Schichten`, "Anzahl"];
                      case "employees":
                        return [`${value} Mitarbeiter`, "Anzahl"];
                      case "avgHoursPerShift":
                        return [`${value.toFixed(1)}h`, "Ø pro Schicht"];
                      case "avgHoursPerEmployee":
                        return [`${value.toFixed(1)}h`, "Ø pro MA"];
                      default:
                        return [value, name];
                    }
                  }}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {weeklyBreakdown.map((week, index) => {
              ...
              return (
                <div
                  key={index}
                  className={`p-4 border rounded-lg space-y-3 transition-all duration-300 hover:shadow-md ${isPeakWeek
                  ...
                  <div className="grid grid-cols-3 gap-2 text-center">
                    ...
                    <div className="p-2 bg-green-50 dark:bg-green-950/20 rounded">
                      <div className="text-sm font-bold text-green-600">
                        {(week.hours / Math.max(week.shifts, 1)).toFixed(1)}h
                      </div>
                      <div className="text-xs text-muted-foreground">
                        Ø/Schicht
                      </div>
                    ...
                    <div className="p-2 bg-purple-50 dark:bg-purple-950/20 rounded">
                      <div className="text-sm font-bold text-purple-600">
                        {(week.hours / Math.max(week.employees, 1)).toFixed(1)}h
                      </div>
                  ...
                  <div className="space-y-2">
                    <div>
                      ...
                      <Progress
                        ...
                        style={
                          {
                            "--progress-foreground": isPeakWeek
                              ? "#10b981"
                              : "#8884d8",
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="p-4 bg-orange-50 dark:bg-orange-950/20 rounded-lg">
                ...
                <div className="text-lg font-bold text-orange-600">
                  KW{" "}
                  {
                    weeklyBreakdown.find((w) => w.hours === minHours)
                      ?.weekNumber
                  }
                </div>
                <div className="text-sm text-muted-foreground">
              ...
              <div className="p-4 bg-blue-50 dark:bg-blue-950/20 rounded-lg">
                ...
                <div className="text-sm text-muted-foreground">pro Woche</div>
              </div>
            </div>
          </CardContent>
        </Card>
