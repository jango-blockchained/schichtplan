...
export function ClassicAIGenerationDialog({
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      toast.error(
        error instanceof Error ? error.message : "Fehler bei der Generierung",
      );
    } finally {
  ...
  const handleExportConversationToOptions = () => {
    ...
    conversation.addSystemMessage(
      "Die Übertragung der Unterhaltung in strukturierte Optionen ist derzeit noch nicht verfügbar.",
    );
  };
      ...
      <DialogContent className="sm:max-w-[900px] max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            Schichtplanerstellung von {startDate} bis {endDate}.
          </DialogDescription>
        </DialogHeader>
