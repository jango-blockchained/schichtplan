  ...
  return (
    <Card>
      <CardHeader className="flex flex-row items-center justify-between">
        ...
        {onCreateNewVersion && (
          <Button variant="outline" size="sm" onClick={onCreateNewVersion}>
            <Plus className="h-4 w-4 mr-2" />
            Neue Version
          </Button>
        )}
        ...
        <Table>
          ...
          <TableBody>
            {currentItems.map((version) => {
              ...
              if (isSelected) {
                console.log(
                  `🎯 VersionTable: Version ${version.version} is currently selected`,
                );
              }
              if (isNew) {
                console.log(
                  `🆕 VersionTable: Version ${version.version} was recently created`,
                );
              }
