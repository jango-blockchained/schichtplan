...
const AISuggestionView: React.FC<AISuggestionViewProps> = () => {
  if (noSuggestions) {
    return (
      <Alert variant="destructive">
        ...
        <AlertDescription>
          The AI could not generate any feasible schedule suggestions with the
          current settings for the selected period.
        </AlertDescription>
      </Alert>
    );
  }
  ...
  return (
    <Tabs
      defaultValue={mockSuggestions[0]?.id || "nosuggestions"}
      className="w-full"
    >
            ...
            <CardHeader>
              ...
              <div className="flex space-x-2 pt-2">
                ...
                <Badge variant="secondary">
                  Fairness: {suggestion.metrics.fairness}
                </Badge>
                <Badge variant="outline">
                  Cost Saving: {suggestion.metrics.costReduction}
                </Badge>
              </div>
            </CardHeader>
      ...
      {mockSuggestions.length === 0 && !noSuggestions && (
        <TabsContent value="nosuggestions">
          <Alert>
            ...
            <AlertDescription>
              Generate a schedule to see AI suggestions here.
            </AlertDescription>
          </Alert>
        </TabsContent>
      )}
