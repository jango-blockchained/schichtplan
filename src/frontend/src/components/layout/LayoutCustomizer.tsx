...
export const LayoutCustomizer: React.FC<LayoutCustomizerProps> = ({
  ...
  const handleTableStyleChange = (
    style: Partial<LayoutConfig["table_style"]>,
    prev: LayoutConfig,
  ) => {
  ...
  const handleFontStyleChange = (
    style: Partial<LayoutConfig["title_style"]>,
    prev: LayoutConfig,
  ) => {
    // ... rest of the function
  };
  ...
  const handleMarginChange = (
    margins: Partial<LayoutConfig["margins"]>,
    prev: LayoutConfig,
  ) => {
    // ... rest of the function
  };
    ...
    <div className="space-y-4 p-4">
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2 flex-1">
          ...
          <Button onClick={() => setIsPresetModalOpen(true)}>Save As</Button>
          <Button
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="space-y-4">
          <TableStyleEditor
            ...
            onChange={(style) =>
              setCurrentConfig((prev) => ({ ...prev, table_style: style }))
            }
          />
          <FontEditor
            titleStyle={currentConfig.title_style}
            onChange={(style) =>
              setCurrentConfig((prev) => ({ ...prev, title_style: style }))
            }
          />
          <MarginEditor
            margins={currentConfig.margins}
            onChange={(margins) =>
              setCurrentConfig((prev) => ({ ...prev, margins }))
            }
          />
        </div>
        <div>
