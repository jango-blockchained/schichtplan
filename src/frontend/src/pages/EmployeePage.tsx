  ...
  return (
    <div className="container mx-auto py-10">
        ...
        <TableBody>
          {currentEmployees?.map((employee) => (
            <TableRow key={employee.id}>
              ...
              <TableCell>
                <span
                  className={`px-2 py-1 rounded-full text-xs ${employee.is_active ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
                >
      ...
      <ConfirmDialog
        ...
        onConfirm={() =>
          alertState.employee && handleDelete(alertState.employee)
        }
