    ...
    if choice == "1":
        ...
        try:
            ...
            if version_to_delete in versions:
                ...
                db.session.commit()
                print(f"Successfully deleted {count} schedules from version {version_to_delete}")
            else:
        ...
        confirm = input("Are you sure you want to delete ALL schedules? This cannot be undone! (yes/no): ")
