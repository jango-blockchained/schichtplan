...
def main():
    ...
    # Create test dates
    today = date.today()
    test_dates = [today + timedelta(days=i) for i in range(1, 4)]  # Tomorrow, day after, and day after that
    ...
    try:
        ...
        for test_date in test_dates:
            for i, shift_id in enumerate(shifts):
                ...
                print(f"Created assignment: Employee {employee_id}, Shift {shift_id}, Date {test_date}")
