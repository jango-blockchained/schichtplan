...
def fix_active_days_format():
    ...
    with app.app_context():
        ...
        for shift in shifts:
            print(
                f"ID: {shift.id}, Type: {shift.shift_type_id}, Active days: {shift.active_days} (type: {type(shift.active_days).__name__})"
            )
...
if __name__ == "__main__":
    ...
    print(
        "This tool converts active_days from dictionary format to list format for the scheduler."
    )
