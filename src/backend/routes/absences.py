...
@bp.route('employees/<int:employee_id>/absences', methods=['GET'])  # Without leading slash for different URL patterns
...
@bp.route('employees/<int:employee_id>/absences', methods=['POST'])  # Without leading slash
...
@bp.route('employees/<int:employee_id>/absences/<int:absence_id>', methods=['DELETE'])  # Without leading slash
@bp.route('/absences/employees/<int:employee_id>/absences/<int:absence_id>', methods=['DELETE'])
...
@bp.route('employees/<int:employee_id>/absences/<int:absence_id>', methods=['PUT'])  # Without leading slash
@bp.route('/absences/employees/<int:employee_id>/absences/<int:absence_id>', methods=['PUT'])
